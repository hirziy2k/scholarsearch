...
**Protocol Reference:** Scoping_Review_Protocol_v7.0.md
**Version:** 1.0
**Date:** September 2026
...
**This document is not a substitute for the protocol.** All methodological decisions (eligibility criteria, search strategy, screening process, synthesis approach) are defined in `Scoping_Review_Protocol_v7.0.md`.
...
- [ ] Enter approved search string (from Protocol Section 11)
- [ ] Apply only protocol-approved filters/limits
- [ ] Record the **exact search string** used (copy verbatim)
- [ ] Record the **total result count** displayed by the database
- [ ] Record the **date and time** of search execution
...
| Search Strategy ID | [e.g., Section 11.4 Combined PubMed] |
...
| Fields Searched | [e.g., Title/Abstract/MeSH] |
| Filters/Limits Applied | [e.g., English, 2000–2026, Human] |
...
- [ ] Execute approved search string
- [ ] Apply protocol-approved filters
- [ ] Record exact search string
...
- [ ] All 7 databases searched (or documented as inaccessible)
- [ ] All grey-literature sources searched
- [ ] Citation chasing completed
...
| Protocol Version | 7.0 |
| Search Strategy ID | Section 11.4 Combined PubMed |
...
| Field | Value |
|---|---|
| Exact Search String | (("dry eye"[tiab] OR "dry eye disease"[tiab] OR ...) AND ("night driving"[tiab] OR ...) AND ("driver"[tiab] OR ...)) |
| Fields Searched | Title/Abstract/MeSH |
| Filters/Limits Applied | English, 2000–2026, Human |
