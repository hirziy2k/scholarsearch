...
const SOURCE_ROUTING: Record<string, string[]> = {
  discovery: ["openalex", "semantic_scholar", "crossref", "core", "eric", "doaj"],
  evidence: ["pubmed", "openalex", "semantic_scholar", "crossref", "core", "eric", "doaj"],
  clinical: ["pubmed", "openalex", "semantic_scholar", "crossref", "core", "eric", "doaj"],
  systematic_review: ["pubmed", "openalex", "semantic_scholar", "crossref", "core", "eric", "doaj"],
  thesis: ["openalex", "semantic_scholar", "crossref", "core", "eric", "doaj"],
  manuscript: ["openalex", "semantic_scholar", "crossref", "core", "eric", "doaj"],
  adversarial: ["openalex", "semantic_scholar", "crossref", "core", "eric", "doaj"],
...
export async function orchestrateSearch(
  ...
  const {
    ...
    andUnsafeSources,
  } = compileForLocalIntersection(query.raw_query, sources);
  ...
  // --- Step 4: Crosswalk compilation for ERIC/DOAJ ---
  //
  ...
  // Re-compile queries with crosswalk for ERIC/DOAJ
  if (crosswalks.size > 0) {
    const { parseAndCompileWithCrosswalk } = await import("@scholarsearch/shared");
    const crosswalkCompiled = parseAndCompileWithCrosswalk(query.raw_query, sources, crosswalks, region);
    // Merge with existing compiled queries (ERIC/DOAJ will be updated)
  ...
  const originalWeights: RankingWeights = query.weights ?? {
    relevance: 0.25,
