# SUPPLEMENT S1 — SEARCH STRATEGIES v1.1 (PRESS-PASSED, FROZEN FOR OSF)

**Review:** Dry Eye Disease, Dry-Eye Symptoms, and Night-Driving Difficulty Among Drivers: A Scoping Review
**Protocol:** Scoping_Review_Protocol_v7.0.md v7.5 (PC-01 to PC-20 + PRESS patch)
**Strategy version:** v1.1 — v1.0r2 + PRESS patch: (1) PubMed phrase-truncation quoting fix; (2) photophobia + scotopic added to C2/C3 all 8 strings; (3) Lite strings driving → (driving OR driver OR drivers)
**PRESS status:** PASSED 6-domain audit (Methodologist / Clinician / Operator lenses) — cleared for OSF registration. DO NOT EXECUTE searches until OSF DOI issued.
...
- C2/C3 (Context/Outcome): Driving / Night Vision / Glare / Mesopic Vision / Scotopic / Photophobia / Halos / Contrast Sensitivity / Headlights / VND-Q

---

## 1. MEDLINE via PubMed (NCBI)

**Syntax:** `[MeSH]` controlled, `[tiab]` free-text. Multi-word truncations quoted per PRESS (unquoted `dry eye*[tiab]` splits under ATM).
...
AND
('car driving'/exp OR 'night'/exp OR 'mesopic vision'/exp OR 'glare'/exp OR 'photophobia'/exp OR 'contrast sensitivity'/exp OR driv*:ti,ab,kw OR 'night driving':ti,ab,kw OR 'night vision':ti,ab,kw OR glare:ti,ab,kw OR photophobia:ti,ab,kw OR 'contrast sensitivity':ti,ab,kw OR 'mesopic vision':ti,ab,kw OR scotopic:ti,ab,kw OR halo:ti,ab,kw OR halos:ti,ab,kw OR starburst*:ti,ab,kw OR 'dark adaptation':ti,ab,kw OR headlight*:ti,ab,kw OR headlamp*:ti,ab,kw OR 'low light':ti,ab,kw OR 'VND-Q':ti,ab,kw)
```
...
AND
([mh "Automobile Driving"] OR [mh "Dark Adaptation"] OR [mh "Vision, Low"] OR [mh "Glare"] OR [mh "Photophobia"] OR [mh "Contrast Sensitivity"] OR [mh "Visual Acuity"] OR driv*:ti,ab,kw OR "night driving":ti,ab,kw OR "night vision":ti,ab,kw OR glare:ti,ab,kw OR photophobia:ti,ab,kw OR "contrast sensitivity":ti,ab,kw OR "mesopic vision":ti,ab,kw OR scotopic:ti,ab,kw OR halo:ti,ab,kw OR halos:ti,ab,kw OR starburst*:ti,ab,kw OR "dark adaptation":ti,ab,kw OR headlight*:ti,ab,kw OR headlamp*:ti,ab,kw OR "low light":ti,ab,kw OR "VND-Q":ti,ab,kw)
```
...
```text
TITLE-ABS-KEY ( ( "dry eye*" OR "dry eye" OR "keratoconjunctivitis sicca" OR "meibomian gland dysfunction" OR "tear film*" OR "tear film" OR "tear break up" OR "tear breakup" OR "tear break-up" OR OSDI OR TBUT OR NIBUT ) AND ( driv* OR "night driving" OR "night vision" OR glare OR photophobia OR "contrast sensitivity" OR "mesopic vision" OR scotopic OR halo OR halos OR starburst* OR "dark adaptation" OR headlight* OR headlamp* OR "low light" OR "VND-Q" ) )
```
...
```text
TS=( ("dry eye*" OR "dry eye" OR "keratoconjunctivitis sicca" OR "meibomian gland dysfunction" OR "tear film*" OR "tear film" OR "tear breakup" OR "tear break up" OR "tear break-up" OR OSDI OR TBUT OR NIBUT) AND (driv* OR "night driving" OR "night vision" OR glare OR photophobia OR "contrast sensitivity" OR "mesopic vision" OR scotopic OR halo OR halos OR starburst* OR "dark adaptation" OR headlight* OR headlamp* OR "low light" OR "VND-Q") )
```
...
**Syntax:** Basic Boolean; flat structure. Driver nouns explicit per PRESS (no bare wildcard reliance).

```text
("dry eye" OR "keratoconjunctivitis sicca" OR "meibomian gland dysfunction" OR "tear film" OR OSDI OR TBUT)
AND
(driving OR driver OR drivers OR "night vision" OR glare OR photophobia OR "contrast sensitivity" OR mesopic OR scotopic OR halos OR headlight OR headlamp OR "VND-Q")
```
...
AND
(driving OR driver OR drivers OR night OR glare OR photophobia OR "contrast sensitivity" OR halos OR headlight OR "VND-Q")
```
...
3. Any syntax error, timeout, or zero-hit anomaly → string invalidated, rewritten as v1.2, re-tested.
...
**FREEZE STATUS: v1.1 PRESS-PASSED — CLEARED FOR OSF REGISTRATION. DO NOT EXECUTE DATA-COLLECTION SEARCHES UNTIL OSF DOI ISSUED.**
