...
metadata:
  tech-stack: Next.js 14, Fastify, TypeScript, Tailwind CSS, Serwist PWA, Prisma, SQLite
...
This repository root (standalone ScholarSearch project).
Migrated from `Default Project/services/scholarsearch` — see `PROVENANCE.md`.
